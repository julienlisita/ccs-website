      ...
      <Section>
        <SectionWrapper className="text-[#785F49] space-y-10 sm:space-y-12">
          ...
          <div>
            ...
            <p>
              Le site <strong>careetservices.pro</strong> est hébergé par :
              <br />
          ...
          <div>
            ...
            <p>
              <strong>Compagnie Care & Services</strong> s’efforce de fournir des informations
              exactes et à jour. Toutefois, elle ne saurait être tenue responsable des erreurs ou
              omissions, ni des dommages résultant de l’utilisation des informations présentes sur
              le site.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Les informations collectées via les formulaires (contact et candidature) sont
              utilisées uniquement pour traiter votre demande et ne sont pas stockées dans une base
              de données à des fins marketing. Pour en savoir plus sur vos droits (accès,
              rectification, suppression), consultez notre{' '}
          ...
          <div className="pb-8 sm:pb-10 md:pb-12 lg:pb-16">
            ...
            <p>
              ...
              <br />
              Illustrations / Icônes : Lucide Icons, Unsplash, Freepik (ou autres ressources libres
              de droits) — si applicable
              <br />
