// src/components/pages/JobOffer.tsx

import { format } from 'date-fns';
import { fr } from 'date-fns/locale';
import { Briefcase } from 'lucide-react';

import type { jobOffers } from '@/data/jobOffers';
import Section from '@/components/common/Section';
import SectionWrapper from '@/components/common/SectionWrapper';
import Button from '@/components/ui/Button';
import HeroPage from '@/components/section/HeroPage';

type JobOffer = (typeof jobOffers)[number];

type JobOfferPageProps = {
  offer: JobOffer;
};

export default function JobOffer({ offer }: JobOfferPageProps) {
